...
const HeroBig = ({ settings }: { settings: SanitySiteSettings }) => {
      ...
      >
        ...
        <div className="flex flex-col gap-6 lg:gap-12 justify-center items-start lg:items-end h-full px-20 lg:px-26">
          ...
          <div className="flex flex-col ">
            ...
            <p className=" text-grayAlt2 text-lg xl:text-xl">
              Focusing on {settings.focus}
            </p>
          </div>
