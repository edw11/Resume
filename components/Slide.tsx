...
const Slide = ({ state }: { state: boolean }) => {
  ...
  return (
    <div className="flex relative w-auto h-auto glass backdrop-blur-3xl bg-black/40 px-3 py-2 rounded-full text-sm border-[#363636] border-[1px]" role="tablist" aria-label="Navigation">
      <div
